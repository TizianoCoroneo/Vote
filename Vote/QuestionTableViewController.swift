...
class QuestionTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let data = Observable<[String]>.just(["Domanda 1", "Domanda 2", "Domanda 3", "Domanda 4"])
        ...
        data.bind(to: tableView.rx.items) {
            ...
            cell.configure(withQuestion: element)
            
            return cell
        }.disposed(by: disposeBag)
//
//        data.bind(to: tableView.rx.items(
//            cellIdentifier: QuestionTableViewCell.identifier,
//            cellType: QuestionTableViewCell.self)) {
