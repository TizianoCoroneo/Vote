...
* Use [github issues](https://github.com/tizianocoroneo/XLProductName/issues) to report a bug.
* Before creating a new issue:
  * Make sure you are working with the [latest release](https://github.com/tizianocoroneo/XLProductName/releases).
  * Check if the issue was [already reported or fixed](https://github.com/tizianocoroneo/XLProductName/issues?utf8=%E2%9C%93&q=is%3Aissue). Notice that it may not be released yet.
...
1. Clone your forked project into your developer machine: `git clone git@github.com:tizianocoroneo/XLProductName.git`
...
We try to follow our [swift style guide](https://github.com/tizianocoroneo/Swift-Style-Guide).
...
* We use `type: feature request` label to mark all [feature request issues](https://github.com/tizianocoroneo/XLProductName/labels/type%3A%20feature%20request).
